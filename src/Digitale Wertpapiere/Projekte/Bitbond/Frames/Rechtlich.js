...
import MRECHTLICH from "../../../Components/Rechtliche_Kachel";

function Rechtlich(props) {
  return props.trigger ? (
    <div>
      <div id="Desktop_Rechtlich_Wrapper">
        <MRECHTLICH
          title="TYP / WKN UND ISIN
"
          Text="Im Rahmen eines öffentlichen Angebots werden 100.000.000 tokenbasierte Schuldverschreibungen mit einem Nennbetrag von jeweils EUR 1, die untereinander gleichberechtigt sind, von der Emittentin ausgegeben. Die Verbriefung ist ausgeschlossen. Daher erfolgt auch keine Hinterlegung einer Urkunde bei einer Depotbank. Für jede emittierte Schuldverschreibung wird ein BB1-Token von der Emittentin an den Anleger herausgegeben. BB1-Token basieren auf der Stellar Blockchain und repräsentieren die Rechte aus der Schuldverschreibung. WKN/ISIN sind nicht vorhanden."
        />
        <MRECHTLICH
          title="GRUNDLAGE DER WERTPAPIERE
"
          Text="Form und Inhalt der tokenbasierten Schuldverschreibungen, die Schuldverschreibungsbedingungen sowie alle Rechte und Pflichten der Gläubiger und der Emittentin bestimmen sich nach deutschem Recht. Ausgestaltet werden die tokenbasierten Schuldverschreibungen maßgeblich durch die Schuldverschreibungsbedingungen."
        />
        <MRECHTLICH
          title="WÄHRUNG DER WERTPAPIEREMISSION
"
          Text="Die Emissionswährung der Wertpapieremission lautet auf Euro.
...
Die Auszahlung des Rückzahlungsbetrags und der Zinsen ist kein technischer Automatismus und kann von der Emittentin nur ausgelöst werden, wenn die notwendige Liquidität dafür vorhanden ist."
        />
        <MRECHTLICH
          title="RECHTE DER GLÄUBIGER
"
          Text="Bei den angebotenen Wertpapieren handelt es sich um tokenbasierten Schuldverschreibungen, die dem Gläubiger einen Anspruch gegen die Emittentin auf Rückzahlung des eingesetzten Kapitals am Ende der Laufzeit und Verzinsung während der Laufzeit gewähren.
...
Der Emittentin wird in den Schuldverschreibungsbedingungen der tokenbasierten Schuldverschreibungen das Recht eingeräumt, diese vor Ablauf der Laufzeit unter Einhaltung einer Kündigungsfrist von drei Monaten, erstmals zum 31.12.2021, danach jeweils jährlich zum 31.12. zu kündigen (ordentliches Kündigungsrecht)."
        />
        <MRECHTLICH
          title="VERJÄHRUNGSFRIST VON ZINSZAHLUNGEN UND RÜCKZAHLUNGSANSPRUCH
"
          Text="Es gelten die gesetzlichen Verjährungsvorschriften nach §§ 195, 199 BGB.
"
        />
        <MRECHTLICH
          title="KÜNDIGUNGSRECHTE DER GLÄUBIGER
"
          Text="Ein ordentliches Kündigungsrecht der Gläubiger besteht nicht. Jeder Gläubiger ist berechtigt, seine Schuldverschreibungen ohne Einhaltung einer Kündigungsfrist zu kündigen und deren Rückzahlung zum Nennbetrag zuzüglich etwaiger bis zum Tage der Rückzahlung (ausschließlich) aufgelaufener Zinsen zu verlangen,wenn ein wichtiger Grund vorliegt. Ein wichtiger Grund liegt insbesondere dann vor, wenn
...
"
        ...
        />
        <MRECHTLICH
          title="INFORMATIONSPFLICHTEN DER EMITTENTIN
"
          Text="Die Emittentin ist verpflichtet, ihren Jahresabschluss zum Ende eines Geschäftsjahres nach den Vorschriften des Handelsgesetzbuches (HGB) spätestens bis zum 31. März des folgenden Kalenderjahres zu erstellen und den Gläubigern durch Einstellung auf ihre Website (www.bitbondsto.com) zur Verfügung zu stellen."
        />
        <MRECHTLICH
          title="VERTRETER DER SCHULDTITELINHABER
"
          Text="Es wurde kein Vertreter der Schuldtitelinhaber bestellt.
"
        />
        <MRECHTLICH
          title="EMISSIONSTERMIN
"
          Text="Die Platzierung der tokenbasierten Schuldverschreibungen beginnt einen Werktag nach der Veröffentlichung des Prospektes. Der voraussichtliche Emissionstermin ist der erste Werktag nach Veröffentlichung des Prospektes, voraussichtlich der 11.03.2019. Im Übrigen ist der Emissionstermin nicht mit dem Datum der Lieferung der tokenbasierten Schuldverschreibungen identisch."
        />
        <MRECHTLICH
          title="ANGABE DER BESCHLÜSSE, ERMÄCHTIGUNGEN UND BEWILLIGUNGEN, DIE DIE GRUNDLAGE FÜR DIEERFOLGTE BZW. NOCH ZU ERFOLGENDE SCHAFFUNG DER WERTPAPIERE UND/ODER DEREN EMISSION BILDEN"
          Text="Die Gesellschafterversammlung der Emittentin hat am 24. September 2018 beschlossen, die Emission von tokenbasierten Schuldverschreibungen durchzuführen und öffentlich anzubieten."
        />
        <MRECHTLICH
          title="ÜBERTRAGBARKEIT DER WERTPAPIERE
"
          Text="Eine Teilübertragung einer tokenbasierten Schuldverschreibung ist nicht zulässig. Die Abtretung der Rechte aus der Schuldverschreibung setzt zwingend die Übertragung der die Schuldverschreibung repräsentierenden BB1-Token voraus (sog. beschränktes Abtretungsverbot). Der Transfer von BB1-Token vollzieht sich ausschließlich über die Stellar Blockchain. Eine Übertragung der Schuldverschreibung außerhalb der Blockchain ist nicht zulässig. Die Übertragung kann also nur gemeinsam mit den BB1-Token erfolgen."
        />
        <MRECHTLICH
          title="ANGABEN ZUR RENDITE
"
          Text="Die Rendite ist wesentlich von der Höhe des jeweiligen jährlichen variablen Zinssatzes für die Schuldverschreibungabhängig. Die mögliche Rendite eines Gläubigers kann daher nicht nach einer anerkannten Zinsberechnungsmethode ermittelt werden. Für die Berechnung der individuellen Rendite eines Gläubigers sind zudem individuelle Transaktionskosten zu berücksichtigen, die z.B. bei der Übersendung der erforderlichen Menge an Kryptowährungen oder für die vom Anleger verwendete Wallet entstehen können."
        />
      </div>
    </div>
  ) : (
