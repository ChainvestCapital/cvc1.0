      ...
      <div id="GP_Details_Wrapper">
        <div id="GP_Details_Var_White_col">
          <h3 id="GP_Details_Var_White_h3">
            Wohnungsdetails - Hochwertig und komfortabel
          </h3>
          <h5 id="FH_Details_h5">
            Bei den Wohneinheiten handelt sich um zwei großzügig geschnittene
            3-Zimmerwohnungen mit jeweils zwei Schlafzimmern, Bad, Gäste-WC und
            einem lichtdurchfluteten Wohn-Ess-Bereich. Highlight bilden die in
            den ruhigen Innenhof gewandten Balkone, welche mit jeweils 23
            Quadratmetern zum Verweilen einladen. Um zukünftigen Mietern ein
          ...
          <h3 id="GP_Details_Var_White_h3">Wohnung 2 - 1. Obergeschoss</h3>{" "}
          ...
          <div id="Uebersee_Details_Under_Wrapper">
            <div id="Uebersee_Details_Under_Wrapper_Left">
              <img
                src="https://chainvest.s3.eu-central-1.amazonaws.com/Boernerstrasse2/Boernerstrasse2Details2.png"
          ...
          <div id="margin_top_2vh"></div> <div id="margin_top_2vh"></div>{" "}
          <div id="margin_top_2vh"></div>{" "}
          <h3 id="GP_Details_Var_White_h3">Wohnung 8 - 4. Obergeschoss</h3>{" "}
          <div id="margin_top_2vh"></div> <div id="margin_top_2vh"></div>{" "}
          <div id="Uebersee_Details_Under_Wrapper">
            <div id="Uebersee_Details_Under_Wrapper_Left">
              <img
