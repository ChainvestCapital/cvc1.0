...
"
          Text="Bei den tokenisierten Genussrechten handelt es sich um schuldrechtliche, inhaltsgleich ausgestaltete Forderungen,deren Inhaberschaft untrennbar mit den sie repräsentierenden Green Ship Token verknüpft sind.
...
"
          Text="Die Laufzeit der tokenisierten Genussrechte beginnt am 1. Juli 2020 und endet spätestens mit Ablauf des 30. Juni 2035, ohne dass es einer Kündigung bedarf.
...
"
          Text="Um Green Ship Token erwerben zu können, ist eine erfolgreiche Registrierung des Erwerbers über die Emissionsplattform unter Angabe aller dort abgefragten Daten sowie der Bestätigung erforderlich, dass der Zeichner erwerbsberechtigt nach Ziffer 7.2 ist.
...
"
          Text="Die Emittentin kann das Genussscheinkapital uneingeschränkt für alle nach ihrer Satzung zulässigen Zwecke einsetzen.
"
        />
        <RECHTLICH_KACHEL
          title="AUSGABE WEITERER GENUSSRECHTE
"
          Text="Die Emittentin behält sich vor, weitere Genussrechte zu gleichen oder anderen Bedingungen auszugeben.
Die Genussrechtsinhaber haben keinen Anspruch darauf, dass ihre Ansprüche aus den tokenisierten Genussrechten vorrangig vor den Ansprüchen bedient werden, die auf weitere Genussrechte entfallen. Die Ansprüche aus weiteren Genussrechten dürfen nicht vorrangig bedient werden."
        ...
        <RECHTLICH_KACHEL
          ...
          Text="Der Bestand der tokenisierten Genussrechte wird weder durch eine Verschmelzung, eine Rechtsformänderung, eine Umwandlung oder durch eine Änderung des gezeichneten Kapitals der Emittentin berührt. Die gläubigerschützen den Vorschriften der §§ 204, 23 des Umwandlungsgesetzes bleiben unberührt."
        />
        <RECHTLICH_KACHEL
          title="ERWERB EIGENER TOKENISIERTER GENUSSRECHTE
"
          Text="Mit dem Beschluss der Gesellschafterversammlung vom 6. März 2020 wurde die Geschäftsführung der Emittentin ermächtigt, jederzeit eigene tokenisierte Genussrechte nach diesen Bedingungen zurück zu erwerben.
