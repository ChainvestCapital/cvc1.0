  ...
  return props.trigger ? (
    <div>
      <div id="Mobile_White_W100_HX">
        ...
        <h4 id="GP_Mob_Lage_W100_h4">Heinersdorf, Pankow</h4>
        ...
        <h5 id="GP_Mob_Lage_W100_h6">
          ...
          Viertels absehbar, einhergehend mit steigenden Mieten und Kaufpreisen.
          Die Gegend rund um das Objekt bildet durch den hohen Anteil an
          Kleingartenanlagen ein grünes und ruhiges Stadtbild ab – eine
          nachgefragte Seltenheit mitten in der urban geprägten Metropole
          Berlin.
        </h5>
      ...
      <div id="Mobile_White_W100_HX">
        ...
        <h5 id="GP_Mob_Lage_W100_h6">
          ...
          bevölkerungsreichste Ebenso ist Berlin die zweit bevölkerungsreichste
          und der Fläche nach die fünftgrößte Stadt der Europäischen Union. Die
          Flüsse Havel und Spree fließen durch Berlin, welches in 12 Bezirke
          bzw. 95 Ortsteile unterteilt ist. Berlin hat das Flair einer
          Weltmetropole, ist innovativ und kreativ. Das zeigt auch der Titel
          „Stadt des Designs“, mit dem die UNESCO die Bundeshauptstadt
