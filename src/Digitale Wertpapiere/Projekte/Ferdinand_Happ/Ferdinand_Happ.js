...
function FerdinandHappStraße() {
  ...
  useEffect(() => {
    document.title = "Ferdinand-Happ-Straße";
  }, []);
  ///////////////////////////////////
  ///////////////////////////////////
        ...
        <div id="Desktop_BG_Grey">
          <div id="Desktop_BG_White">
            ...
            <Top_Header_IMMO
              ...
              extLink="https://finexity.com/marketplace/DE-FRA-02"
              Kategorie={Kategorie}
              Rendite={Rendite}
              ...
              weiterebg2={Überseeallee_Galerie_1}
              weitereLogo2={Finexity_Logo}
              weitereLink="../Digitale-Wertpapiere/Ueberseeallee"
            ...
            <div id="Projekt_Content_Wrapperx">
              ...
              <div id="Projekt_Content_Frame_Wrapper">
                ...
                <Galerie
                  trigger={Galerieshown}
                  setTrigger={setGalerieshown}
                />{" "}
                <RISIKO_BANNER />
              </div>{" "}
            </div>{" "}
