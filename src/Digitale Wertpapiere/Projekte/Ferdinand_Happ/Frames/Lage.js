    ...
    <div>
      <div id="Lage_Wrapper_GP">
        <div id="Lage_Wrapper_GP_left">
          ...
          <h4 id="Lage_Wrapper_GP_h4">Innenstadt IV - Ostend</h4>{" "}
          <img
        ...
        <div id="Lage_Wrapper_GP_right">
          ...
          <h6 id="Lage_Wrapper_GP_h6">
            ...
            von 4,8% und eine Kaufkraft von 26.265 € pro Einwohner. <br></br>
            <br />
          ...
          <h4 id="Lage_Wrapper_GP_h4">Erholung und Natur</h4>
          <h6 id="Lage_Wrapper_GP_h6">
            {" "}
