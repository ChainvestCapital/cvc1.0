...
function GlückburgerPlatz(props) {
  /*       Getting Infos       */
  ///////////////////////////////
  ...
  const title = "Glücksburger Platz";
  ...
  useEffect(() => {
    document.title = "Glückburger Platz";
  }, []);
  ///////////////////////////////////
  ///////////////////////////////////
        ...
        <div id="Desktop_BG_Grey">
          <div id="Desktop_BG_White">
            ...
            <Top_Header_IMMO
              ...
              extLink="https://finexity.com/marketplace/DE-HH-08"
              Kategorie={Kategorie}
              Rendite={Rendite}
...
export default GlückburgerPlatz;
