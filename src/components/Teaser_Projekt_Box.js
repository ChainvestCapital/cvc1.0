import "./Teaser_Projekt_Box.css";

import arrow from "../assets/images/Arrow_white.png";
function Home11_Proj_Comp(props) {
  console.log(props.KategorieBildLink);
  return (
    <div>
      <div id="Teaser_Proj_Comp_Wrapper">
        <div id="teaser_Proj_Comp_top">
          <img src={props.titleImg} id="Home11_Proj_Comp_BG_Img" alt="" />
          <div id="Home_Proj_Comp_top_Logo_Wrapper">
            <img src={props.Logo} id="teaser_Proj_Comp_Logo_Img" alt="" />
          </div>
        </div>
